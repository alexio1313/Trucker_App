...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  function handleSignOut() {
    localStorage.clear();
    window.location.href = 'http://192.168.8.101:3010/login';
  }
      ...
      <aside className="w-64 bg-slate-900 text-white flex flex-col">
        ...
        <div className="p-4 border-t border-slate-700 shrink-0">
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-red-400 hover:bg-red-900 hover:text-red-300 transition-colors"
          >
